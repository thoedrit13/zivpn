#!/bin/bash
# Zivpn UDP Module installer - ARM + Dynamic Auto Exclude
...
# สร้างไฟล์ Systemd Service (สังเกตการเรียกใช้งาน zivpn server -c /etc/zivpn/config.json)
...
echo -e "\nZIVPN Installed Successfully (ARM Architecture)!"
